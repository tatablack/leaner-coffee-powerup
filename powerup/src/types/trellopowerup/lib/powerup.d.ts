...
export interface CapabilityHandlers {
  ...
  "card-detail-badges"?: (t: HostHandlers.CallbackHandler) => Promise<(CardDetailBadgeDynamic | CardDetailBadge)[]>;
  "card-from-url"?: () => void;
  "format-url"?: () => void;
...
export interface DebuggingOptions {
  Sentry?: {
    configureScope(
      callback: (scope: { setTags(name: string, value: string): void; setUser(value: { id: string }): void }) => void,
    ): void;
  };
  helpfulStacks?: boolean;
}
